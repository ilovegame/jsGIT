...
//TODO diff between added = undef and lack of this value
//TODO api for single files
//TODO convert diff to nice string
...
function getDiffWorkingTreeAndIndex (repoPath, callback)
{
...
// @param repoPath - path of .git dir
// @param callback - function (err, diffs), diffs: dictionary { file_name : diff }
function getDiffHeadIndex (repoPath, callback)
{
	getIndexObjects(repoPath, function (err, newBlobs) {
		...
		else
		{
			...
			gs.getHeadSha1(gitpath, function (err, headSha1) {
				if (err)
				{
					callback(err, null);
				}
...
// @param callback - function (err, diffs), diffs: dictionary { file_name : diff }
function getDiffCommitCommit (repoPath, oldCommitSha1, newCommitSha1, callback)
{
