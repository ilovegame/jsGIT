...
Index.prototype.addObjectFromHEAD = function(path, callback) {
    var indexFile = this;
    Index.prototype.getRelativePath.call(indexFile, path, function(relativePath) {
        guM.getHeadAndTreeDir(indexFile.repoPath, function(err, head, treeInfo, graph) {      
            if(treeInfo[relativePath]) {//we return info about the file to index only if it was in head
                ...
                fileInfo['gid'] = 0;
                fileInfo['size'] = 0;
                fileInfo['SHA_1'] = treeInfo[relativePath]['sha1'];
                fileInfo['flag'] = 0;
                ...
                //if the file is not in head we remove it from index
                Index.prototype.removeObject.call(indexFile, path, function(err) {
                    callback('');   
                });
            }
        });
