...
Index.prototype.createObjectInfo2 = function (path, callback) {
    var relPath =  path.slice(ph.normalize(ph.join(this.repoPath,'..')).length+1);
    guM.getHeadAndTreeDir(this.repoPath, function(err, head, treeInfo, graph) {
        if (err) {
            callback(err);
            return;
        }
      ...
      [ ctime: 0,
        ...
        gid: 0,
        size: 0,
        SHA_1: '286c59a4e130d7d8e8bbb765ee03b3bf23a4d247',
        flag: 5,
        path: 'a.txt' ] },
*/
        var pathBuffer = new Buffer(relPath, 'utf8');
        var indexFile = this;
        var objectInfo = new Array();
        var index = 0;
        objectInfo['ctime'] = 0;
        ...
        objectInfo['dev'] = 0;
        objectInfo['ino'] = 0;
        objectInfo['mode'] = 33188;
        objectInfo['uid'] = 0;
        objectInfo['gid'] = 0;
        objectInfo['size'] = 0;
        objectInfo['SHA_1'] = treeInfo[relPath]['sha1'];//(uM.convertHexToDigesttreeInfo[relPath]['sha1']).toString(); // ????FUCK
        objectInfo['flag'] = pathBuffer.length;
        objectInfo['path'] = relPath;
        callback(undefined, objectInfo);
