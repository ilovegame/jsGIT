...
/*
 * dir -> directory path
 * done->callback(err, filenames)
 * filenames is dictionary of all files containted in dir after traversal
 * without directories
 * for example filenames = { a.txt : { 'mtime' : mtime}, b/a.txt : { 'mtime' : mtime} };
 * note there's no b entry
 */
