...
var gCCM = require('gitCheckoutCommand.js');
...
var addOneFile = function(path, repoPath, callback) {
    ...
    cPM.load(repoPath, function(err, cParser) {
        if (err) {
            ...
            if (cParser.removeConflict(relativePath)) {
...
var removeOneFile = function(path, repoPath, callback) {
    ...
    /*
        indexFileManager.hasObject(path, function(has) {
            if (has) {
                indexFileManager.removeObject(path, function(err) {
                    if (err) {
                        callback(err);
...
var removeAllFiles = function(repoPath, callback) {
    guM.getHeadSha1(repoPath, function(err, sha1) {
        ...
        gCCM.gitCheckout(sha1, repoPath, function(err) {
            if (err) {
                callback(err);
                return;
            }
