...
var test = function(packs, discovery)
{
    ...
    console.log(packs);
    scanPack(packs[0], function(err, data){
 ...
 */
var cloneGit = function(repoPath, remoteRepoGit)
{
    clone.getPacks(remoteRepoGit, function(packs, discovery)
    {
        scanPack(packs[0], function(err, data){
            var objects = rebuildObjects(packs[0], data);
            gi.init('test', function(err){
 ...
 * @param callback callback called when adding ins finished
 */
