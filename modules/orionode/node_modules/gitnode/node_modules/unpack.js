...
//        inflatedLength = len2[1]; //????
        dellen = pf.getBaseObjectOffset(cutData, cut);
        cut += dellen[0];
    }
    else if(type === 'delta2')
    {
...
//        }
        ...
        utils.deflateOpts(last, function(err, deflatedData){
            ...
            else
            {
                if(parsed == 78)
                {
                    ...
                    console.log(objData.slice(objData.length - cutData.length - 5, objData.length));
                    console.log(cutData);
                }
    ...
    inflate.write(cutData.slice(0, inflatedLength));
//    var i = -1;
